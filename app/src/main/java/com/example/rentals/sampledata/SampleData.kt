...
val sampleOrderItems = listOf(
    ...
    DeliveryItem("3", "Rajni Chhatria", LocalDate.now().plusDays(1).toString(), LocalTime.of(9, 0).toString(), 7525.00, "ongoing", "user789", null, null, OffsetDateTime.now(ZoneOffset.UTC).minusDays(1).toString(), "Makri"),
